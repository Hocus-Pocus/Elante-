;****************************************************************************
;
;                      MS_TECA_V12_Elante_3_10_10a.asm 3/10/10
;                              MT V2.25 compatable
...
;****************************************************************************
;  _Elante_3_10_10a:
;  This version just has the lates configuration coded
;****************************************************************************
...
; - TPS bins for 2D interpolation of EPC tables(TPS_range:)
     ...
     db     14T      ; TPS_range[1] 14% throttle opening
     db     28T      ; TPS_range[2] 28% throttle opening
     db     42T      ; TPS_range[3] 42% throttle opening
     db     56T      ; TPS_range[4] 56% throttle opening
     db     70T      ; TPS_range[5] 70% throttle opening
     db     84T      ; TPS_range[6] 84% throttle opening
...
; - Flash Configuration Constants
     ...
     db     237T    ; WOT_cnt     ; Wide Open throttle position ADC count
     db     189T    ; TPSspan     ; WOT_cnt - CT_cnt = TPSspan
     db     2T      ; CT_min      ; Closed throttle position minimum %
     db     20T     ; TrimFac     ; EPC Trim adjustment max value
     db     7T      ; TuneConfig  ; Tuning configuration variable
