...
.list                                     ; Turn on listing file
     ...
     include "MSnS460.inc"                ; Include definitions for
                                          ; MSnS460.asm
...
FtrimCalc:
     ...
     mov     #$1C,Trm_Ang_Fac  ; Move decimal 28 into "Trm_Ang_Fac" (no ign trim 8 cyl)
...
;SLOW_RPM_CALC:
     ...
     lda     #$1D                ; Load accumulator with $1D ("RPMk" 8 cyl)
     sta     intacc1+2           ; Copy to "intacc1+2
     lda     #$4C                ; Load accumulator with $4C ("RPMk+1" 8 cyl)
...
;
;   tachcurH:tachcurL is added to tachTH:tachTM:TachTL 16 times then divided by 16 to average
;   the period to smooth the read out.
;
;***********************************************************************************************
...
;***********************************************************************************************
; - Check the value of "tachcnt" to see if it's time to average the period values
;***********************************************************************************************

     lda     tachcnt              ; load accumulator with value in "tachcnt"
                                  ; (Tachometer averaging counter)
     cmp     #$10                 ; Compare with decimal 16
     beq     AV_PERIOD            ; If equal, branch to AV_PERIOD: (it's time to average)
     bra     HI_RES_TACH_DONE     ; Branch to HI_RES_TACH_DONE: (not time to average yet)

AV_PERIOD:

;***********************************************************************************************
; - Divide tachTH:tachTM:tachTL by 16 to average the period and save as tachH:tachL for actual
;   Hi Res Tach calculations By MV or TS.
;***********************************************************************************************
...
;***********************************************************************************************
     ...
     lsr     tachTH     ; Logical shift right "tachTH" (divide by 2 Lo Byte)
     ror     tachTM     ; Rotate right throught carry "tachTM" (divide by 2 Mid Byte)
     ror     tachTL     ; Rotate right throught carry "tachTL" (divide by 2 Hi Byte)
...
;***********************************************************************************************
; - Fourth divide by 2 (2x2x2=16 divide)
;***********************************************************************************************
...
;***********************************************************************************************
; - Save the averaged values as tachH:tachL, clear "tachTH:tachTM:tachTL" and "tachcnt"
;***********************************************************************************************

     lda     tachTM     ; Load accumulator with value in "tachTM"
     sta     tachH      ; copyt to "tachH" (tachometer period Hi Byte averaged)
     lda     tachTL     ; Load accumulator with value in "tachTL"
     sta     tachL      ; copyt to "tachL" (tachometer period Lo Byte averaged)
...
;     brset   clock,inputs,TAE    ; If "clock" bit of "inputs" variable is
                                  ; clear, branch to TAE:
...
REVNUM:          db     00T
textversion_f:   db     'MSnS460 by Robert Hiebert ******'
...
VE_f:
	...
	db      54T,54T,52T,53T,54T,54T,54T,54T,55T,56T,57T,57T ; VE (1,0-11)
	db      66T,66T,64T,63T,65T,65T,65T,65T,66T,68T,69T,69T ; VE (2,0-11)
	db      69T,69T,69T,70T,71T,72T,73T,74T,75T,76T,77T,78T ; VE (3,0-11)
	db      70T,70T,71T,72T,73T,73T,74T,74T,75T,76T,77T,78T ; VE (4,0-11)
	db      71T,71T,72T,73T,74T,74T,75T,76T,77T,78T,78T,79T ; VE (5,0-11)
	...
	db      104T,104T,105T,107T,110T,112T,114T,115T,115T,115T,114T,114T; VE (11,0-11)(Top Row)
...
ST_f:
	db    207T,213T,184T,153T,145T,142T,136T,130T,125T,125T,122T,122T ;(0,0-11)(Bottom Row)
	db    207T,213T,184T,153T,145T,142T,136T,130T,125T,125T,122T,122T ;(1,0-11)
	db    190T,190T,173T,159T,150T,147T,142T,136T,133T,130T,128T,125T ;(2,0-11)
	db    181T,181T,170T,162T,153T,150T,147T,139T,136T,133T,130T,128T ;(3,0-11)
	db    184T,184T,173T,164T,156T,153T,150T,142T,139T,136T,133T,130T ;(4,0-11)
	db    187T,187T,179T,170T,162T,159T,153T,145T,139T,139T,136T,136T ;(5,0-11)
	db    193T,193T,184T,173T,164T,159T,153T,147T,139T,139T,136T,136T ;(6,0-11)
	db    193T,193T,190T,181T,176T,167T,162T,153T,150T,147T,142T,139T ;(7,0-11)
	db    196T,196T,193T,190T,187T,179T,170T,162T,156T,153T,147T,142T ;(8,0-11)
	db    210T,210T,201T,196T,190T,184T,181T,173T,167T,162T,153T,147T ;(9,0-11)
	db    221T,221T,215T,210T,204T,196T,190T,179T,176T,170T,162T,153T ;(10,0-11)
	db    224T,224T,221T,218T,215T,204T,193T,187T,179T,173T,167T,162T ;(11,0-11)(Top Row)
...
AFR2_f:
	...
	db    88T,88T,88T,88T,88T,88T,88T,88T,88T,88T,88T,88T ;(10,0-11)
	db    88T,88T,88T,88T,88T,88T,87T,87T,86T,86T,85T,85T ;(11,0-11)(Top Row)
...
WWU:        db      180T    ; WWU   Warmup bin @ -40 F
            db      180T    ; WWU   Warmup bin @ -20 F
            db      160T    ; WWU   Warmup bin @   0 F
            db      150T    ; WWU   Warmup bin @ +20 F
            db      145T    ; WWU   Warmup bin @ +40 F
            db      140T    ; WWU   Warmup bin @ +60 F
            db      135T    ; WWU   Warmup bin @ +80 F
            db      125T    ; WWU   Warmup bin @ +100 F
            db      118T    ; WWU   Warmup bin @ +130 F
...
cwu:        db      200T    ; CWU          Crank Enrichment at - 40 F
cwh:        db      50T     ; CWH          Crank Enrichment at +165 F
...
req_fuel:   db      126T    ; REQFUEL      Required fuel constant
divider:    db      2T      ; DIVIDER      IRQ divide factor for fuel pulse
...
WOT_cnt:    db      237T    ; WOT_cnt      Wide Open throttle position ADC count
...
BnkflowL:   db      93T     ; BnkflowL     Injector bank flow rate L/hr x 10 Lo byte
                            ;              configuration variable
